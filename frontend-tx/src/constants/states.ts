...
export const STATE_GROUPS = {
    ...
    OCCUPIED: [POSITION_STATES.OCUPADO, POSITION_STATES.PREASIGNADO, POSITION_STATES.ASIGNADO, POSITION_STATES.ENCAMINO, POSITION_STATES.ENCURSO],
...
export const TAXI_DISPLAY_STATES = {
    CONNECTED: [POSITION_STATES.ACTIVO, POSITION_STATES.OCUPADO, POSITION_STATES.ASIGNADO, POSITION_STATES.ENCAMINO, POSITION_STATES.ENCURSO],
