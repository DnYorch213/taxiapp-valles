...
export const POSITION_STATES = {
    ...
    // Taxista: ocupado fuera del despacho automático
    OCUPADO: "ocupado",

    // Taxista: fuera de servicio manualmente
    INACTIVO: "inactivo",
...
export const STATE_TRANSITIONS: Record<PositionState, PositionState[]> = {
    [POSITION_STATES.ACTIVO]: [POSITION_STATES.ASIGNADO, POSITION_STATES.OCUPADO, POSITION_STATES.INACTIVO],
    [POSITION_STATES.OCUPADO]: [POSITION_STATES.ACTIVO, POSITION_STATES.INACTIVO],
    [POSITION_STATES.INACTIVO]: [POSITION_STATES.ACTIVO, POSITION_STATES.OCUPADO],
    ...
    [POSITION_STATES.DESCONECTADO]: [POSITION_STATES.ACTIVO, POSITION_STATES.OCUPADO, POSITION_STATES.INACTIVO],
};
...
export const STATE_GROUPS = {
    ...
    OCCUPIED: [POSITION_STATES.OCUPADO, POSITION_STATES.ASIGNADO, POSITION_STATES.ENCAMINO, POSITION_STATES.ENCURSO] as const,
